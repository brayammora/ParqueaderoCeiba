...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        // window?.rootViewController = container.resolve(MainParkViewController.self)!
        window?.rootViewController = UINavigationController(rootViewController: container.resolve(MainParkViewController.self)!)
